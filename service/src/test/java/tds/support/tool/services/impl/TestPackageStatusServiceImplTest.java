...
public class TestPackageStatusServiceImplTest {
    ...
    public void shouldSearchForTestPackageStatusRecordsByName() {
        ...
        when(mockTestPackageStatusRepository.findAllByNameContaining(testPackageName, pageRequest))
        ...
        verify(mockTestPackageStatusRepository).findAllByNameContaining(testPackageName, pageRequest);
