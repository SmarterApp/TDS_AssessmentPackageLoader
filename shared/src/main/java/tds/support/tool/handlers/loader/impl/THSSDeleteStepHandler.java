...
public class THSSDeleteStepHandler implements TestPackageHandler {
    ...
    private final THSSService thssTestPackageService;
    ...
    @Autowired
    public THSSDeleteStepHandler(final THSSService thssTestPackageService,
        ...
        this.thssTestPackageService = thssTestPackageService;
    ...
    public void handle(final Job job, final Step step) {
        try {
            ...
            thssTestPackageService.deleteTestPackage(testPackage);
